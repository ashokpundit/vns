...
<body>
<div style="width:960px; float:center; margin:0 auto">
    	...
    	<table>
            ...
            <tr>
            	<td style="padding-bottom:20px;">
					<a href="tips.php"><img src="http://www.onlineia.com/vns/img/tips.jpg" width="220;" border="0" /></a>
                </td>
            </tr>
        	<tr>
            ...
            <tr>
            	<td style="padding-bottom:20px;">
					<a href=""><img src="http://www.onlineia.com/vns/img/testperformance.JPG" width="220;" border="0" /></a> <!--mychart.php -->
                </td>
            </tr>
         </table>   
	</div>
	<div style="width:708px; float:right; padding-bottom:20px;">
        <table align="center"  border="0" style="padding-top:20px; padding-bottom:20px; width:700px; text-align:justify; font-family:Verdana, Arial, Helvetica, sans-serif; line-height:20px;">
          <tr>
            <td align="center">
            <strong><p>Welcome <?php echo $_SESSION["name"]; ?></p></strong>
             </td>
            </tr>
          <tr>
...
<div style="vertical-align: bottom;width: 800px;">
     		<?php 
				include("Bottom.php");
			?>
</div>
